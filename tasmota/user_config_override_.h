...
// BRGIN: Implementation of features desired bi me (scintik) for test
#define USE_MIEL_HVAC                            // Add support for Mitsubishi Electric HVAC serial interface (+5k code)
// need continue, if everything is ok, to undef modules  not used to decrease dimension of final bin.
// [..must continue]
